...
const dateish = z.preprocess(
  ...
  z.union([z.string().datetime(), z.string().date(), z.coerce.date()])
    .transform((v) => new Date(v as never))
    .optional()
);
...
export const createProjectSchema = z.object({
  ...
  category: z.enum(["client", "non_client"]).default("client"),
  startDate: dateish,
  endDate: dateish,
...
export const listProjectsQuerySchema = z.object({
  ...
  category: z.enum(["client", "non_client"]).optional(),
