...
async function main() {
    ...
    const teamMembers = [
        { name: "Tahir Ahmad", email: "tahir@qubartech.com", role: "member" },
        { name: "Rafiul Islam", email: "rafi@qubartech.com", role: "member" },
        { name: "Rakibul Islam", email: "rakib@qubartech.com", role: "member" },
    ];
