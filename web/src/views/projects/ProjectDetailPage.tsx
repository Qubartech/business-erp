  ...
  return (
    <>
      <PageHeader title={project.name}
        ...
        actions={canEdit ? (
          <div className="flex items-center gap-2">
            <button className="btn-secondary hover:-translate-y-0.5 transform transition-all duration-200 cursor-pointer" onClick={() => setProjectModalOpen(true)}>Edit</button>
            <button className="btn-secondary hover:-translate-y-0.5 transform transition-all duration-200 cursor-pointer" onClick={() => nav(`/documents/generate?projectId=${project.id}`)}>Generate Doc</button>
            <button className="btn-secondary hover:-translate-y-0.5 transform transition-all duration-200 cursor-pointer" onClick={() => archive.mutate()} disabled={project.status === "archived" || archive.isPending}>
