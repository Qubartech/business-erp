      ...
      <aside className={clsx(
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  {desktopCollapsed && (
                    <div className={clsx(
                      "absolute left-full top-0 bottom-0 pl-3 pr-5 flex items-center rounded-r-xl border-y border-r opacity-0 translate-x-[-5px] group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200 pointer-events-none whitespace-nowrap z-50 text-sm font-semibold",
                      isActive
                        ? "bg-brand-50/90 dark:bg-brand-900/40 text-brand-700 dark:text-brand-400 border-brand-650/40 dark:border-brand-500/40"
                        : "bg-slate-100/90 dark:bg-zinc-800/70 text-slate-900 dark:text-slate-100 border-slate-200/60 dark:border-white/[0.06]"
                    )}>
                      {item.label}
                    </div>
                  )}
        ...
        <div className={clsx(
          ...
          <div className={clsx("flex items-center", desktopCollapsed ? "" : "gap-3")}>
            ...
            {desktopCollapsed && (
              <div className="absolute left-full top-0 bottom-0 pl-3 pr-5 flex items-center rounded-r-xl border-y border-r opacity-0 translate-x-[-5px] group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200 pointer-events-none whitespace-nowrap z-50 text-sm font-semibold bg-slate-100/90 dark:bg-zinc-800/70 text-slate-900 dark:text-slate-100 border-slate-200/60 dark:border-white/[0.06] shadow-sm">
                {user?.name || "User"}
              </div>
            )}
          </div>
