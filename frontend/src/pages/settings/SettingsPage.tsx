...
export default function SettingsPage() {
  ...
  return (
    <>
      ...
      <div className="card p-6 border border-slate-100 mt-6">
        <h3 className="text-base font-semibold text-slate-800 flex items-center gap-2 mb-2">
        ...
        {apiKeyLoading ? (
          ...
          <div className="space-y-4">
            <div>
              <label className="label font-semibold text-xs text-slate-600 block mb-1">Your API Key</label>
              <div className="flex gap-2 max-w-xl">
                <div className="relative flex-1">
                  <input
                    type={showKey ? "text" : "password"}
                    className="input font-mono text-[11px] bg-slate-50 border-slate-200 select-all w-full pr-10 py-1.5 px-2.5 rounded-lg"
                    readOnly
          ...
          <div>
            <p className="text-xs text-amber-600 bg-amber-50 border border-amber-100 rounded-lg p-3 max-w-xl mb-4">
